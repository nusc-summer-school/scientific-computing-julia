...
- Perform data analysis and visualization with Julia
...
- 15:15 - 16:45: Data Analysis and Visualisation

### Day 2: Numerical Methods and Simulations
- 09:00 - 10:30: Numerical Integration and Optimisation
...
[JuliaHub](https://juliahub.com) provides a cloud environment for Julia:
...
3. Clone this repository:
   ...
   Pkg.add("LibGit2")
   using LibGit2
   LibGit2.clone("https://github.com/nusc-summer-school/scientific-computing-julia.git", "workshop")
   ```
4. Open the workshop directory and access the materials

### Option 3: Using Binder

[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/nusc-summer-school/scientific-computing-julia/HEAD)

Click the Binder badge above to launch a ready-to-use environment in your browser.

### Option 4: Using JupyterLab with Julia Kernel
